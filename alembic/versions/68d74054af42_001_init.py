...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "priority", sa.Enum("LOW", "MEDIUM", "HIGH", "URGENT", name="ticket_priority", schema="ticket"), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "APPROVED", "REJECTED", name="approval_process_status", schema="ticket"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "notify_on_event",
            sa.Enum("ON_CREATE", "ON_CLOSE", "ON_STATUS_CHANGE", "ON_NEW_COMMENT", name="notification_event", schema="ticket"),
            nullable=False,
        ),
        sa.Column("created_by", sa.BigInteger(), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.text("now()"), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "APPROVED", "REJECTED", name="approval_process_step_status", schema="ticket"),
            nullable=False,
        ),
