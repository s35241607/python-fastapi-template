...
class ApprovalProcess(Base):
    ...
    ticket_id = Column(BigInteger, ForeignKey("ticket.tickets.id", ondelete="CASCADE"), unique=True)
    approval_template_id = Column(BigInteger, ForeignKey("ticket.approval_templates.id", ondelete="SET NULL"))
