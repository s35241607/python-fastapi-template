...
async def read_categories(services: CategoryService = Depends(CategoryService)):
    return await services.get_all_categories()


@router.get("/{category_id}", response_model=Category)
async def read_category(category_id: int, services: CategoryService = Depends(CategoryService)):
...
async def hard_delete_category(category_id: int, services: CategoryService = Depends(CategoryService)):
